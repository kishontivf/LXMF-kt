...
dependencies {
    ...
    api("com.github.kishontivf.reticulum-kt:rns-core:0.1.0")

    // Coroutines
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core:$coroutinesVersion")

    // Test dependencies for live networking tests
    testImplementation("com.github.kishontivf.reticulum-kt:rns-interfaces:0.1.0")
    ...
    testImplementation("com.github.kishontivf.reticulum-kt:rns-test:0.1.0")
